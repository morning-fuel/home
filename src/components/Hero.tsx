...
Light, energizing, and ready when you are.
          ...
          <h1
            className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white leading-[1.08] mb-5 opacity-0 animate-fade-up text-balance"
            style={{ animationDelay: "0.25s" }}
          >
            Fresh Fruit Bowls Starting at JUST ₹69
          </h1>

          <p
            className="text-white/85 text-base md:text-lg max-w-md mx-auto md:mx-0 mb-8 opacity-0 animate-fade-up"
            style={{ animationDelay: "0.4s" }}
          >
            Kickstart your morning with fresh, ready-to-eat fruit bowls
            delivered to your doorstep in Ahmedabad.
          </p>
